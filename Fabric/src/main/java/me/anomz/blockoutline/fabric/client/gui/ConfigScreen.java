...
public class ConfigScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(this.font, "Outline Settings", leftColumnCenter, 56, 0x00FFFF);
        graphics.drawCenteredString(this.font, "Fill Settings", rightColumnCenter, 56, 0x00FFFF);
    }
